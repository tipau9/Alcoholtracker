...
enum DrinkDatabase {
    ...
    private static let bier: [DrinkTemplate] = [
        ...
        DrinkTemplate(name: "Erdinger Weißbier",            category: .beer, volume: 500, abv: 5.3,  calories: 220, iconName: "mug.fill"),
        DrinkTemplate(name: "Franziskaner Weissbier",       category: .beer, volume: 500, abv: 5.0,  calories: 215, iconName: "mug.fill"),
        ...
        DrinkTemplate(name: "Paulaner Hefe-Weißbier",       category: .beer, volume: 500, abv: 5.5,  calories: 225, iconName: "mug.fill"),
        ...
        DrinkTemplate(name: "Schneider Weisse Original",    category: .beer, volume: 500, abv: 5.4,  calories: 220, iconName: "mug.fill"),
        DrinkTemplate(name: "Maisel's Weisse",              category: .beer, volume: 500, abv: 5.2,  calories: 210, iconName: "mug.fill"),
        DrinkTemplate(name: "Erdinger Kristall",            category: .beer, volume: 500, abv: 5.3,  calories: 215, iconName: "mug.fill"),
        DrinkTemplate(name: "Erdinger Dunkel",              category: .beer, volume: 500, abv: 5.6,  calories: 225, iconName: "mug.fill"),
        DrinkTemplate(name: "Schöfferhofer Hefeweizen",     category: .beer, volume: 500, abv: 5.0,  calories: 210, iconName: "mug.fill"),
        DrinkTemplate(name: "Hacker-Pschorr Hefe Weiße",   category: .beer, volume: 500, abv: 5.5,  calories: 225, iconName: "mug.fill"),
    ...
    private static let spirituosen: [DrinkTemplate] = [
        DrinkTemplate(name: "Aperol Pur",                   category: .spirits, volume: 40,  abv: 11.0, calories: 60,  iconName: "flame.fill"),
        DrinkTemplate(name: "Baileys",                      category: .spirits, volume: 40,  abv: 17.0, calories: 130, iconName: "flame.fill"),
        DrinkTemplate(name: "Campari Pur",                  category: .spirits, volume: 40,  abv: 25.0, calories: 60,  iconName: "flame.fill"),
        DrinkTemplate(name: "Fernet Branca",                category: .spirits, volume: 30,  abv: 39.0, calories: 75,  iconName: "flame.fill"),
        DrinkTemplate(name: "Gin Pur",                      category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Jägermeister",                 category: .spirits, volume: 20,  abv: 35.0, calories: 50,  iconName: "flame.fill"),
        DrinkTemplate(name: "Limoncello",                   category: .spirits, volume: 30,  abv: 30.0, calories: 80,  iconName: "flame.fill"),
        DrinkTemplate(name: "Ouzo",                         category: .spirits, volume: 20,  abv: 38.0, calories: 55,  iconName: "flame.fill"),
        DrinkTemplate(name: "Pfeffi",                       category: .spirits, volume: 20,  abv: 30.0, calories: 55,  iconName: "flame.fill"),
        DrinkTemplate(name: "Rum Shot",                     category: .spirits, volume: 20,  abv: 40.0, calories: 55,  iconName: "flame.fill"),
        DrinkTemplate(name: "Rum (neat)",                   category: .spirits, volume: 40,  abv: 40.0, calories: 90,  iconName: "flame.fill"),
        DrinkTemplate(name: "Schnaps Korn",                 category: .spirits, volume: 20,  abv: 32.0, calories: 45,  iconName: "flame.fill"),
        DrinkTemplate(name: "Tequila Shot",                 category: .spirits, volume: 20,  abv: 38.0, calories: 50,  iconName: "flame.fill"),
        DrinkTemplate(name: "Vodka Shot",                   category: .spirits, volume: 20,  abv: 40.0, calories: 55,  iconName: "flame.fill"),
        DrinkTemplate(name: "Whiskey Shot",                 category: .spirits, volume: 20,  abv: 40.0, calories: 55,  iconName: "flame.fill"),
        DrinkTemplate(name: "Whiskey (neat)",               category: .spirits, volume: 40,  abv: 43.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Williams Birne",               category: .spirits, volume: 20,  abv: 40.0, calories: 55,  iconName: "flame.fill"),

        // Vodka Marken
        DrinkTemplate(name: "Smirnoff Red Label",           category: .spirits, volume: 40,  abv: 37.5, calories: 90,  iconName: "flame.fill"),
        DrinkTemplate(name: "Absolut Vodka",                category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Russian Standard Vodka",       category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Stolichnaya Vodka",            category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),

        // Gin Marken
        DrinkTemplate(name: "Bombay Sapphire",              category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Tanqueray Gin",                category: .spirits, volume: 40,  abv: 43.1, calories: 100, iconName: "flame.fill"),
        DrinkTemplate(name: "Monkey 47 Gin",                category: .spirits, volume: 40,  abv: 47.0, calories: 110, iconName: "flame.fill"),
        DrinkTemplate(name: "The Botanist Gin",             category: .spirits, volume: 40,  abv: 46.0, calories: 108, iconName: "flame.fill"),
        DrinkTemplate(name: "Beefeater Gin",                category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Gordon's Gin",                 category: .spirits, volume: 40,  abv: 37.5, calories: 90,  iconName: "flame.fill"),

        // Rum Marken
        DrinkTemplate(name: "Captain Morgan Spiced",        category: .spirits, volume: 40,  abv: 35.0, calories: 85,  iconName: "flame.fill"),
        DrinkTemplate(name: "Havana Club 3 Anos",           category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Diplomatico Reserva",          category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Ron Zacapa 23",                category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Kraken Spiced Rum",            category: .spirits, volume: 40,  abv: 47.0, calories: 110, iconName: "flame.fill"),
        DrinkTemplate(name: "Stroh Rum 80",                 category: .spirits, volume: 20,  abv: 80.0, calories: 90,  iconName: "flame.fill"),

        // Whisky und Whiskey Marken
        DrinkTemplate(name: "Jack Daniel's",                category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Jim Beam",                     category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Jameson",                      category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Johnnie Walker Red",           category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Johnnie Walker Black",         category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Glenfiddich 12",               category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "The Macallan 12",              category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Bulleit Bourbon",              category: .spirits, volume: 40,  abv: 45.0, calories: 103, iconName: "flame.fill"),
        DrinkTemplate(name: "Maker's Mark",                 category: .spirits, volume: 40,  abv: 45.0, calories: 103, iconName: "flame.fill"),

        // Tequila Marken
        DrinkTemplate(name: "Jose Cuervo Gold",             category: .spirits, volume: 40,  abv: 38.0, calories: 90,  iconName: "flame.fill"),
        DrinkTemplate(name: "Sierra Silver Tequila",        category: .spirits, volume: 40,  abv: 38.0, calories: 90,  iconName: "flame.fill"),
        DrinkTemplate(name: "Patron Silver",                category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),

        // Brände und Schnäpse
        DrinkTemplate(name: "Aquavit",                      category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Doppelkorn",                   category: .spirits, volume: 20,  abv: 38.0, calories: 45,  iconName: "flame.fill"),
        DrinkTemplate(name: "Korn",                         category: .spirits, volume: 20,  abv: 32.0, calories: 38,  iconName: "flame.fill"),
        DrinkTemplate(name: "Mirabelle",                    category: .spirits, volume: 20,  abv: 40.0, calories: 45,  iconName: "flame.fill"),
        DrinkTemplate(name: "Zwetschge",                    category: .spirits, volume: 20,  abv: 40.0, calories: 45,  iconName: "flame.fill"),
        DrinkTemplate(name: "Kirsch",                       category: .spirits, volume: 20,  abv: 40.0, calories: 45,  iconName: "flame.fill"),

        // Vodka Erweiterung
        DrinkTemplate(name: "Beluga Noble",                 category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),

        // Gin Erweiterung
        DrinkTemplate(name: "Roku Gin",                     category: .spirits, volume: 40,  abv: 43.0, calories: 100, iconName: "flame.fill"),

        // Rum Erweiterung
        DrinkTemplate(name: "Old Pascas Brown 73",          category: .spirits, volume: 20,  abv: 73.0, calories: 105, iconName: "flame.fill"),

        // Whisky Erweiterung
        DrinkTemplate(name: "Chivas Regal 12",              category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),
        DrinkTemplate(name: "Tullamore Dew",                category: .spirits, volume: 40,  abv: 40.0, calories: 95,  iconName: "flame.fill"),

        // Tequila Erweiterung
        DrinkTemplate(name: "Don Julio Blanco",             category: .spirits, volume: 40,  abv: 38.0, calories: 90,  iconName: "flame.fill"),
        DrinkTemplate(name: "Olmeca Altos Plata",           category: .spirits, volume: 40,  abv: 38.0, calories: 90,  iconName: "flame.fill"),
    ]

    // MARK: Liköre

    private static let likoere: [DrinkTemplate] = [
        DrinkTemplate(name: "Averna",                       category: .liqueur, volume: 40,  abv: 29.0, calories: 95,  iconName: "wineglass.fill"),
        DrinkTemplate(name: "Ramazzotti",                   category: .liqueur, volume: 40,  abv: 30.0, calories: 100, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Cynar",                        category: .liqueur, volume: 40,  abv: 16.5, calories: 65,  iconName: "wineglass.fill"),
        DrinkTemplate(name: "Underberg",                    category: .liqueur, volume: 20,  abv: 44.0, calories: 62,  iconName: "wineglass.fill"),
        DrinkTemplate(name: "Pernod",                       category: .liqueur, volume: 40,  abv: 40.0, calories: 90,  iconName: "wineglass.fill"),
        DrinkTemplate(name: "Pastis",                       category: .liqueur, volume: 40,  abv: 40.0, calories: 90,  iconName: "wineglass.fill"),
        DrinkTemplate(name: "Cointreau",                    category: .liqueur, volume: 40,  abv: 40.0, calories: 140, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Grand Marnier",                category: .liqueur, volume: 40,  abv: 40.0, calories: 135, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Triple Sec",                   category: .liqueur, volume: 40,  abv: 30.0, calories: 120, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Malibu Kokos",                 category: .liqueur, volume: 40,  abv: 21.0, calories: 145, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Kahlúa",                       category: .liqueur, volume: 40,  abv: 20.0, calories: 120, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Tia Maria",                    category: .liqueur, volume: 40,  abv: 20.0, calories: 120, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Galliano",                     category: .liqueur, volume: 40,  abv: 30.0, calories: 105, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Drambuie",                     category: .liqueur, volume: 40,  abv: 40.0, calories: 105, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Frangelico",                   category: .liqueur, volume: 40,  abv: 20.0, calories: 115, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Amaretto Disaronno",           category: .liqueur, volume: 40,  abv: 28.0, calories: 135, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Berentzen Apfelkorn",          category: .liqueur, volume: 40,  abv: 20.0, calories: 115, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Raki",                         category: .liqueur, volume: 20,  abv: 45.0, calories: 60,  iconName: "wineglass.fill"),
        DrinkTemplate(name: "Saurer Apfel Schnapps",        category: .liqueur, volume: 40,  abv: 16.0, calories: 90,  iconName: "wineglass.fill"),
        DrinkTemplate(name: "Absinth",                      category: .liqueur, volume: 20,  abv: 55.0, calories: 75,  iconName: "wineglass.fill"),
        DrinkTemplate(name: "Advocaat",                     category: .liqueur, volume: 40,  abv: 14.0, calories: 125, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Amarula",                      category: .liqueur, volume: 40,  abv: 17.0, calories: 115, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Sheridan's",                   category: .liqueur, volume: 40,  abv: 15.5, calories: 125, iconName: "wineglass.fill"),
    ]

    // MARK: Shots

    private static let shots: [DrinkTemplate] = [
        DrinkTemplate(name: "Berliner Luft",                category: .shot, volume: 20, abv: 18.0, calories: 35,  iconName: "flame.fill"),
        DrinkTemplate(name: "Kümmerling",                   category: .shot, volume: 20, abv: 35.0, calories: 60,  iconName: "flame.fill"),
        DrinkTemplate(name: "Sourz Apple",                  category: .shot, volume: 20, abv: 15.0, calories: 38,  iconName: "flame.fill"),
        DrinkTemplate(name: "Sourz Raspberry",              category: .shot, volume: 20, abv: 15.0, calories: 38,  iconName: "flame.fill"),
        DrinkTemplate(name: "B-52",                         category: .shot, volume: 20, abv: 28.0, calories: 50,  iconName: "flame.fill"),
        DrinkTemplate(name: "Wodka Feige",                  category: .shot, volume: 20, abv: 20.0, calories: 42,  iconName: "flame.fill"),
        DrinkTemplate(name: "Tequila Sunrise Shot",         category: .shot, volume: 20, abv: 18.0, calories: 42,  iconName: "flame.fill"),
        DrinkTemplate(name: "Unicum",                       category: .shot, volume: 20, abv: 40.0, calories: 58,  iconName: "flame.fill"),
        DrinkTemplate(name: "Schwarzwald Shot",             category: .shot, volume: 20, abv: 35.0, calories: 55,  iconName: "flame.fill"),
        DrinkTemplate(name: "Baby Guinness",                category: .shot, volume: 20, abv: 25.0, calories: 45,  iconName: "flame.fill"),
        DrinkTemplate(name: "Tequila Slammer",              category: .shot, volume: 20, abv: 38.0, calories: 50,  iconName: "flame.fill"),
        DrinkTemplate(name: "Sourz Pink",                   category: .shot, volume: 20, abv: 15.0, calories: 38,  iconName: "flame.fill"),
    ]
    ...
    private static let mischgetraenke: [DrinkTemplate] = [
        DrinkTemplate(name: "Bacardi Breezer Lime",         category: .mixed, volume: 275, abv: 5.5,  calories: 185, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Jim Beam Cola",                category: .mixed, volume: 330, abv: 10.0, calories: 215, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Jack Daniel's Cola",           category: .mixed, volume: 330, abv: 10.0, calories: 220, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Wodka Energy Dose",            category: .mixed, volume: 250, abv: 7.0,  calories: 150, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Smirnoff Ice Cranberry",       category: .mixed, volume: 330, abv: 4.0,  calories: 165, iconName: "cylinder.fill"),
        DrinkTemplate(name: "V+ Cola",                      category: .mixed, volume: 330, abv: 10.0, calories: 215, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Berentzen Mix",                category: .mixed, volume: 330, abv: 16.0, calories: 345, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Tequila Sunrise Dose",         category: .mixed, volume: 330, abv: 5.5,  calories: 175, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Schwarze Sau",                 category: .mixed, volume: 330, abv: 17.0, calories: 295, iconName: "cylinder.fill"),
    ]
    ...
    private static let csvSortiment: [DrinkTemplate] = [
        ...
        DrinkTemplate(name: "Krombacher Weizen",                category: .beer,  volume: 500, abv: 5.3, calories: 228, iconName: "mug.fill"),
        ...
        DrinkTemplate(name: "Benediktiner Weissbier",           category: .beer,  volume: 500, abv: 5.4, calories: 232, iconName: "mug.fill"),
        ...
        // MARK: Weizenbier
        DrinkTemplate(name: "Paulaner Hefe-Weißbier Naturtrüb",       category: .beer,  volume: 500, abv: 5.5, calories: 236, iconName: "mug.fill"),
        DrinkTemplate(name: "Paulaner Hefe-Weißbier Alkoholfrei",     category: .other, volume: 500, abv: 0.5, calories: 60,  iconName: "mug.fill"),
        DrinkTemplate(name: "Franziskaner Hefe-Weissbier Naturtrüb",  category: .beer,  volume: 500, abv: 5.0, calories: 215, iconName: "mug.fill"),
        DrinkTemplate(name: "Franziskaner Alkoholfrei",                category: .other, volume: 500, abv: 0.5, calories: 60,  iconName: "mug.fill"),
        DrinkTemplate(name: "Maisel's Weisse Original",                category: .beer,  volume: 500, abv: 5.2, calories: 223, iconName: "mug.fill"),
        DrinkTemplate(name: "Störtebeker Bernstein-Weizen",            category: .beer,  volume: 500, abv: 5.3, calories: 228, iconName: "mug.fill"),
        DrinkTemplate(name: "Erdinger Alkoholfrei Zitrone",            category: .other, volume: 330, abv: 0.3, calories: 40,  iconName: "mug.fill"),
        ...
        // MARK: Altbier
        DrinkTemplate(name: "Frankenheim Alt",                  category: .beer,  volume: 330, abv: 4.8, calories: 136, iconName: "mug.fill"),
        DrinkTemplate(name: "Bolten Alt",                       category: .beer,  volume: 330, abv: 4.9, calories: 139, iconName: "mug.fill"),
        ...
        DrinkTemplate(name: "Paulaner Weißbier-Zitrone",        category: .mixed, volume: 500, abv: 2.5, calories: 250, iconName: "mug.fill"),
        ...
        DrinkTemplate(name: "Beck's Green Lemon",               category: .mixed, volume: 330, abv: 2.5, calories: 165, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Beck's Green Lemon Zero",          category: .other, volume: 330, abv: 0.0, calories: 40,  iconName: "cylinder.fill"),
        DrinkTemplate(name: "Beck's Ice",                       category: .mixed, volume: 330, abv: 2.5, calories: 165, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Beck's Red Holunder",              category: .mixed, volume: 330, abv: 2.5, calories: 165, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Beck's Lemon Brew",                category: .mixed, volume: 330, abv: 2.5, calories: 165, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Salitos Original",                 category: .mixed, volume: 330, abv: 5.9, calories: 167, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Salitos Ice",                      category: .mixed, volume: 330, abv: 5.2, calories: 147, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Salitos Blue",                     category: .mixed, volume: 330, abv: 5.0, calories: 142, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Salitos Pink",                     category: .mixed, volume: 330, abv: 5.0, calories: 142, iconName: "cylinder.fill"),
        DrinkTemplate(name: "Salitos 0,0%",                     category: .other, volume: 330, abv: 0.0, calories: 40,  iconName: "cylinder.fill"),
        ...
        // MARK: Whiskey / Whisky (40 ml Serving)
        DrinkTemplate(name: "Jack Daniel's Old No. 7",          category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Jack Daniel's Gentleman Jack",     category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Jack Daniel's Single Barrel",      category: .spirits, volume: 40, abv: 45.0, calories: 99, iconName: "flame.fill"),
        DrinkTemplate(name: "Jack Daniel's Tennessee Honey",    category: .liqueur, volume: 20, abv: 35.0, calories: 43, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Jim Beam Bourbon Whiskey",         category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Jim Beam Red Stag",                category: .liqueur, volume: 20, abv: 32.5, calories: 40, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Jim Beam Apple",                   category: .liqueur, volume: 20, abv: 32.5, calories: 40, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Johnnie Walker Red Label",         category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Johnnie Walker Black Label",       category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Jameson Irish Whiskey",            category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Tullamore D.E.W. Irish Whiskey",   category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Chivas Regal 12 Years",            category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Glenfiddich 12 Years Single Malt", category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Maker's Mark Bourbon",             category: .spirits, volume: 40, abv: 45.0, calories: 99, iconName: "flame.fill"),
        DrinkTemplate(name: "Lagavulin 16 Years Single Malt",   category: .spirits, volume: 40, abv: 43.0, calories: 94, iconName: "flame.fill"),
        DrinkTemplate(name: "Laphroaig 10 Years Single Malt",   category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),

        // MARK: Vodka (40 ml)
        DrinkTemplate(name: "Absolut Vodka Blue",               category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Absolut Citron",                   category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Absolut Kurant",                   category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Smirnoff Red Label No. 21",        category: .spirits, volume: 40, abv: 37.5, calories: 82, iconName: "flame.fill"),
        DrinkTemplate(name: "Three Sixty Vodka",                category: .spirits, volume: 40, abv: 37.5, calories: 82, iconName: "flame.fill"),
        DrinkTemplate(name: "Three Sixty Black 42",             category: .spirits, volume: 40, abv: 42.0, calories: 92, iconName: "flame.fill"),
        DrinkTemplate(name: "Wodka Gorbatschow Vodka",          category: .spirits, volume: 40, abv: 37.5, calories: 82, iconName: "flame.fill"),
        DrinkTemplate(name: "9 Mile Vodka",                     category: .spirits, volume: 40, abv: 37.5, calories: 82, iconName: "flame.fill"),
        DrinkTemplate(name: "Belvedere Vodka",                  category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Grey Goose Vodka",                 category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Finlandia Vodka",                  category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Skyy Vodka",                       category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),

        // MARK: Gin (40 ml)
        DrinkTemplate(name: "Gordon's London Dry Gin",          category: .spirits, volume: 40, abv: 37.5, calories: 82, iconName: "flame.fill"),
        DrinkTemplate(name: "Gordon's Pink Gin",                category: .spirits, volume: 40, abv: 37.5, calories: 82, iconName: "flame.fill"),
        DrinkTemplate(name: "Gordon's Sicilian Lemon",          category: .spirits, volume: 40, abv: 37.5, calories: 82, iconName: "flame.fill"),
        DrinkTemplate(name: "Bombay Sapphire London Dry Gin",   category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Tanqueray London Dry Gin",         category: .spirits, volume: 40, abv: 43.1, calories: 94, iconName: "flame.fill"),
        DrinkTemplate(name: "Tanqueray Flor de Sevilla",        category: .spirits, volume: 40, abv: 41.3, calories: 90, iconName: "flame.fill"),
        DrinkTemplate(name: "Hendrick's Gin",                   category: .spirits, volume: 40, abv: 41.4, calories: 91, iconName: "flame.fill"),
        DrinkTemplate(name: "Monkey 47 Schwarzwald Dry Gin",    category: .spirits, volume: 40, abv: 47.0, calories: 103, iconName: "flame.fill"),
        DrinkTemplate(name: "Beefeater London Dry Gin",         category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Gin Sul Dry Gin",                  category: .spirits, volume: 40, abv: 43.0, calories: 94, iconName: "flame.fill"),
        DrinkTemplate(name: "Malfy Gin Rosa",                   category: .spirits, volume: 40, abv: 41.0, calories: 90, iconName: "flame.fill"),
        DrinkTemplate(name: "Malfy Gin Limone",                 category: .spirits, volume: 40, abv: 41.0, calories: 90, iconName: "flame.fill"),

        // MARK: Rum (40 ml)
        DrinkTemplate(name: "Bacardi Carta Blanca",             category: .spirits, volume: 40, abv: 37.5, calories: 82, iconName: "flame.fill"),
        DrinkTemplate(name: "Bacardi Carta Oro",                category: .spirits, volume: 40, abv: 37.5, calories: 82, iconName: "flame.fill"),
        DrinkTemplate(name: "Bacardi Carta Negra",              category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Bacardi Oakheart Spiced",          category: .spirits, volume: 40, abv: 35.0, calories: 77, iconName: "flame.fill"),
        DrinkTemplate(name: "Havana Club 3 Años",               category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Havana Club 7 Años",               category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Havana Club Especial",             category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Captain Morgan Spiced Gold",       category: .spirits, volume: 40, abv: 35.0, calories: 77, iconName: "flame.fill"),
        DrinkTemplate(name: "Captain Morgan White Rum",         category: .spirits, volume: 40, abv: 37.5, calories: 82, iconName: "flame.fill"),
        DrinkTemplate(name: "Ron Zacapa Centenario 23",         category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Botucal Reserva Exclusiva",        category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Don Papa Rum",                     category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Plantation Pineapple Rum",         category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),

        // MARK: Weinbrand / Cognac / Brandy (40 ml)
        DrinkTemplate(name: "Asbach Uralt",                     category: .spirits, volume: 40, abv: 38.0, calories: 83, iconName: "flame.fill"),
        DrinkTemplate(name: "Chantré Weinbrand",                category: .spirits, volume: 40, abv: 36.0, calories: 79, iconName: "flame.fill"),
        DrinkTemplate(name: "Mariacron Weinbrand",              category: .spirits, volume: 40, abv: 36.0, calories: 79, iconName: "flame.fill"),
        DrinkTemplate(name: "Wilthener Goldkrone",              category: .spirits, volume: 40, abv: 28.0, calories: 61, iconName: "flame.fill"),
        DrinkTemplate(name: "Hennessy V.S Cognac",              category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Rémy Martin V.S.O.P Cognac",       category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Osborne Veterano Brandy",          category: .spirits, volume: 40, abv: 30.0, calories: 66, iconName: "flame.fill"),
        DrinkTemplate(name: "Osborne 103 Brandy",               category: .spirits, volume: 40, abv: 30.0, calories: 66, iconName: "flame.fill"),

        // MARK: Anis / Korn / Grappa / Obstbrand / Tequila / Cachaca (40 ml)
        DrinkTemplate(name: "Ouzo 12",                          category: .spirits, volume: 40, abv: 38.0, calories: 83, iconName: "flame.fill"),
        DrinkTemplate(name: "Pernod Anis",                      category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Ricard Pastis",                    category: .spirits, volume: 40, abv: 45.0, calories: 99, iconName: "flame.fill"),
        DrinkTemplate(name: "Nordhäuser Doppelkorn",            category: .spirits, volume: 40, abv: 38.0, calories: 83, iconName: "flame.fill"),
        DrinkTemplate(name: "Nordhäuser Eiskorn",               category: .spirits, volume: 40, abv: 32.0, calories: 70, iconName: "flame.fill"),
        DrinkTemplate(name: "Berentzen Korn",                   category: .spirits, volume: 40, abv: 32.0, calories: 70, iconName: "flame.fill"),
        DrinkTemplate(name: "Strothmann Weizenkorn",            category: .spirits, volume: 40, abv: 32.0, calories: 70, iconName: "flame.fill"),
        DrinkTemplate(name: "Oldesloer Weizenkorn",             category: .spirits, volume: 40, abv: 32.0, calories: 70, iconName: "flame.fill"),
        DrinkTemplate(name: "Julia Grappa",                     category: .spirits, volume: 40, abv: 38.0, calories: 83, iconName: "flame.fill"),
        DrinkTemplate(name: "Nonino Grappa Vendemmia",          category: .spirits, volume: 40, abv: 41.0, calories: 90, iconName: "flame.fill"),
        DrinkTemplate(name: "Schladerer Kirschwasser",          category: .spirits, volume: 40, abv: 42.0, calories: 92, iconName: "flame.fill"),
        DrinkTemplate(name: "Schladerer Williams-Birne",        category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Schladerer Himbeergeist",          category: .spirits, volume: 40, abv: 42.0, calories: 92, iconName: "flame.fill"),
        DrinkTemplate(name: "Prinz Williams-Christ-Birne",      category: .spirits, volume: 40, abv: 41.0, calories: 90, iconName: "flame.fill"),
        DrinkTemplate(name: "Prinz Alte Marille",               category: .spirits, volume: 40, abv: 41.0, calories: 90, iconName: "flame.fill"),
        DrinkTemplate(name: "Lantenhammer Haselnuss",           category: .spirits, volume: 40, abv: 42.0, calories: 92, iconName: "flame.fill"),
        DrinkTemplate(name: "Sierra Tequila Silver",            category: .spirits, volume: 40, abv: 38.0, calories: 83, iconName: "flame.fill"),
        DrinkTemplate(name: "Sierra Tequila Reposado",          category: .spirits, volume: 40, abv: 38.0, calories: 83, iconName: "flame.fill"),
        DrinkTemplate(name: "Jose Cuervo Especial Silver",      category: .spirits, volume: 40, abv: 38.0, calories: 83, iconName: "flame.fill"),
        DrinkTemplate(name: "Jose Cuervo Especial Reposado",    category: .spirits, volume: 40, abv: 38.0, calories: 83, iconName: "flame.fill"),
        DrinkTemplate(name: "San Cosme Mezcal Artesanal",       category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Pitu Cachaca",                     category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),
        DrinkTemplate(name: "Nega Fulo Cachaca",                category: .spirits, volume: 40, abv: 41.5, calories: 91, iconName: "flame.fill"),
        DrinkTemplate(name: "Janeiro Cachaca",                  category: .spirits, volume: 40, abv: 40.0, calories: 88, iconName: "flame.fill"),

        // MARK: Likör (20 ml Standard; Baileys/Amarula 50 ml)
        DrinkTemplate(name: "Jägermeister Kräuterlikör",        category: .liqueur, volume: 20, abv: 35.0, calories: 43, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Jägermeister Scharf",              category: .liqueur, volume: 20, abv: 33.0, calories: 41, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Baileys Original Irish Cream",     category: .liqueur, volume: 50, abv: 17.0, calories: 52, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Baileys Salted Caramel",           category: .liqueur, volume: 50, abv: 17.0, calories: 52, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Ramazzotti Amaro",                 category: .liqueur, volume: 20, abv: 30.0, calories: 37, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Kahlua Kaffeelikör",               category: .liqueur, volume: 20, abv: 20.0, calories: 25, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Malibu Coconut",                   category: .liqueur, volume: 20, abv: 21.0, calories: 26, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Licor 43 Cuarenta Y Tres",         category: .liqueur, volume: 20, abv: 31.0, calories: 38, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Cointreau Orangenlikör",           category: .liqueur, volume: 20, abv: 40.0, calories: 50, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Disaronno Amaretto",               category: .liqueur, volume: 20, abv: 28.0, calories: 35, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Southern Comfort Likör",           category: .liqueur, volume: 20, abv: 35.0, calories: 43, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Batida de Coco",                   category: .liqueur, volume: 20, abv: 16.0, calories: 20, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Berentzen Apfel",                  category: .liqueur, volume: 20, abv: 18.0, calories: 22, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Berentzen Saurer Apfel",           category: .liqueur, volume: 20, abv: 16.0, calories: 20, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Berentzen Waldmeister",            category: .liqueur, volume: 20, abv: 16.0, calories: 20, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Kuemmerling Kräuterlikör",         category: .liqueur, volume: 20, abv: 35.0, calories: 43, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Kleiner Feigling Original",        category: .liqueur, volume: 20, abv: 20.0, calories: 25, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Amarula Cream Liqueur",            category: .liqueur, volume: 50, abv: 17.0, calories: 52, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Eckes Edelkirsch",                 category: .liqueur, volume: 20, abv: 20.0, calories: 25, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Pfeffi Pfefferminzlikör",          category: .liqueur, volume: 20, abv: 18.0, calories: 22, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Berliner Luft Pfefferminzlikör",   category: .liqueur, volume: 20, abv: 18.0, calories: 22, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Averna Amaro",                     category: .liqueur, volume: 20, abv: 29.0, calories: 36, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Bols Peppermint",                  category: .liqueur, volume: 20, abv: 24.0, calories: 30, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Bols Blue Curacao",                category: .liqueur, volume: 20, abv: 21.0, calories: 26, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Killepitsch Kräuterlikör",         category: .liqueur, volume: 20, abv: 42.0, calories: 52, iconName: "wineglass.fill"),
        DrinkTemplate(name: "Underberg Kräuterlikör",           category: .liqueur, volume: 20, abv: 44.0, calories: 55, iconName: "wineglass.fill"),
    ]
    ...
    private static let neueDrinks: [DrinkTemplate] = [
        ...
        // Altbier (Düsseldorf, served in short 300ml Alt-Becher)
        DrinkTemplate(name: "Uerige Altbier",               category: .beer, volume: 300, abv: 4.7,  calories: 128, iconName: "mug.fill"),
        DrinkTemplate(name: "Schlüssel Alt",                category: .beer, volume: 300, abv: 4.8,  calories: 130, iconName: "mug.fill"),
        DrinkTemplate(name: "Schumacher Alt",               category: .beer, volume: 300, abv: 4.7,  calories: 128, iconName: "mug.fill"),
        DrinkTemplate(name: "Füchschen Alt",                category: .beer, volume: 300, abv: 4.8,  calories: 130, iconName: "mug.fill"),
        DrinkTemplate(name: "Diebels Alt",                  category: .beer, volume: 330, abv: 4.9,  calories: 142, iconName: "mug.fill"),

        // Bockbier
        DrinkTemplate(name: "Spaten Optimator",             category: .beer, volume: 500, abv: 7.2,  calories: 300, iconName: "mug.fill"),
        DrinkTemplate(name: "Weihenstephaner Korbinian",    category: .beer, volume: 500, abv: 7.4,  calories: 310, iconName: "mug.fill"),
        ...
        // Shots erweitert
        DrinkTemplate(name: "Fireball",                     category: .shot, volume: 30,  abv: 33.0, calories: 72,  iconName: "flame.fill"),
        DrinkTemplate(name: "Jägermeister Shot",            category: .shot, volume: 20,  abv: 35.0, calories: 50,  iconName: "flame.fill"),
        DrinkTemplate(name: "Mexikaner",                    category: .shot, volume: 20,  abv: 15.0, calories: 35,  iconName: "flame.fill"),
        DrinkTemplate(name: "Tequila Gold",                 category: .shot, volume: 20,  abv: 38.0, calories: 48,  iconName: "flame.fill"),
        DrinkTemplate(name: "Sambuca",                      category: .shot, volume: 25,  abv: 38.0, calories: 72,  iconName: "flame.fill"),
    ...
    static func seedIfNeeded(in context: ModelContext) {
        ...
        let canonical = Dictionary(uniqueKeysWithValues: defaults.map { ($0.name, $0.iconName) })
        for entry in existing where !entry.isCustom {
            if let newIcon = canonical[entry.name], entry.iconName != newIcon {
                entry.iconName = newIcon
            }
        }
        try? context.save()
